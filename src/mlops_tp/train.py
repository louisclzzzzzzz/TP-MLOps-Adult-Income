...
# Defaults to a local SQLite file so the project works without any server.
_default_tracking_uri = "sqlite:///" + str(Path(__file__).resolve().parent.parent.parent / "mlflow.db")
